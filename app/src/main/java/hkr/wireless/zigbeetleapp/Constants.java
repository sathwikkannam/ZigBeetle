...
public class Constants {
    ...
    */
    ...
    public static final byte[] COORDINATOR_MAC = {0x00, 0x13, (byte) 0xA2, 0x00, 0x41, (byte) 0xC7, 0x20, 0x1C};
    public static final byte[] TEMPERATURE_DESTINATION_16 = {(byte) 0xAC, (byte) 0xAB};
    public static final byte[] FAN_DESTINATION_16 = {(byte) 0xB1, (byte) 0xAC};
    public static final byte[] HEATER_DESTINATION_16 = {(byte) 0x13, (byte) 0xED};
    public static final byte[] COORDINATOR_DESTINATION_16 = {(byte) 0x0F, (byte) 0x11};
